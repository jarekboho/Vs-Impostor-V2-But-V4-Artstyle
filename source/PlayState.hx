...
class PlayState extends MusicBeatState
{
	...
	var flashSprite:FlxSprite = new FlxSprite(-270, -170).makeGraphic(5000, 5000, 0xFFb30000);
	...
	override public function create()
	{
		...
		switch(SONG.stage)
		{
			...
			case 'sabotage':
				{
					defaultCamZoom = 0.75;
					curStage = 'sabotage';
				var sky:FlxSprite = new FlxSprite(-400, -400).loadGraphic(Paths.image('polus/polus_custom_sky'));
				...
				var rocks:FlxSprite = new FlxSprite(-700, -300).loadGraphic(Paths.image('polus/polusrocks'));
				rocks.updateHitbox();
				...
				var hills:FlxSprite = new FlxSprite(-1050, -180.55).loadGraphic(Paths.image('polus/polusHills'));
				hills.updateHitbox();
				...
				var warehouse:FlxSprite = new FlxSprite(50, -400).loadGraphic(Paths.image('polus/polus_custom_lab'));
				...
				var ground:FlxSprite = new FlxSprite(-1350, 80).loadGraphic(Paths.image('polus/polus_custom_floor'));
				ground.updateHitbox();
				...
				speaker.frames = Paths.getSparrowAtlas('polus/speakerlonely');
				...
				snow.frames = Paths.getSparrowAtlas('polus/snow');
			...
			case 'meltdown':
				...
				speaker.antialiasing = true;
		                ...
		                var bfdead:FlxSprite = new FlxSprite(600, 525).loadGraphic(Paths.image('polus/bfdead'));
				...
				snow.setGraphicSize(Std.int(snow.width * 2));
		                ...
		                crowd2.frames = Paths.getSparrowAtlas('polus/boppers_meltdown');
		...
		gf = new Character(300, -120, gfVersion);
		...
		boyfriend = new Boyfriend(870, 200, SONG.player1);
	...
	*/
	...
	override function beatHit()
	{
		...
		if (curBeat % gfSpeed == 0)
        {
            ...
            else if(curSong == 'Sussus-Moogus' && curStep <= 1840)
            {
                gf.dance();
            }
        }
